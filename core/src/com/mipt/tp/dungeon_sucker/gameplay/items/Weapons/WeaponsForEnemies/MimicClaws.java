...
public class MimicClaws extends Weapon {
    ...
    public void getObtained(Entity holder) {
        ...
        this.generateSkillForCreature(new DamageRandomEnemy(this, this.damage, DamageTypeSet.Point, ElementSet.None, true, 0, this.holder.isHostile));
        this.generateSkillForCreature(new DamageOneRandomEnemyWithCrit(this, this.damage, 0.5, DamageTypeSet.Point, ElementSet.None, true, 0, 1, 2, 6, this.holder.isHostile));
