...
public class Window implements LibGDXDrawable {
  ...
  public Window(IntVector2 topLeftPoint, IntVector2 bottomRightPoint) {
    ...
    width = (bottomRightPoint.x - topLeftPoint.x) * Constants.cellSize;
    height = (topLeftPoint.y - bottomRightPoint.y) * Constants.cellSize;
  ...
  protected void drawBoard()
  {
    ...
    batch.begin();
    batch.draw(board, topLeftPoint.x * Constants.cellSize, bottomRightPoint.y * Constants.cellSize);
    batch.end();
  }
